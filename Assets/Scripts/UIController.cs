...
public class UIController : MonoBehaviour {
	...
	// Change Block Type 1 -> 2 TEST
	public Button blockType2;
	...
	void Update () {
		...
		// Taken from video resource by Iain
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            else
            {
                ...
                if (Physics.Raycast(mousePos, out hitResults))
                {
                    ...
                    if (cube != null)
                    {
						cube.PrefabToSpawn = blockToPlace;
		...
		// End of taken from video resource
	...
	public void ChangeBlockToPlace(GameObject block){
		blockToPlace = block;
	}
}
